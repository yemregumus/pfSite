...
const MatrixRainingCode = () => {
  ...
  useEffect(() => {
    ...
    const characters = "THEMATRIX0123456789ﾊﾐﾋｰｳｼﾅﾓﾆｻﾜﾂｵﾘｱﾎﾃﾏｹﾒｴｶｷﾑﾕﾗｾﾈｽﾀﾇﾍﾘｸYUNUSEMREGUMUS╌";
    ...
    let frameRate = 15; // Adjust the frame rate (lower value = slower speed)
  ...
  return <canvas className="matrix-canvas fixed top-0" style={{ width: "100%", height: "100%", zIndex: -1 }} ref={canvasRef}></canvas>;
};
